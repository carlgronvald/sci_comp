...
[X1,T1] = ESDIRK23(x0, @vanderpolf, @vanderpoljac, 0.5, 0, 40, 0.01, 0.01, parameters);
...
xlabel("t")
ylabel("value")
legend("x(1), ESDIRK23 adaptive step", "x(1), ode15s")
figure 
...
[X1,T1] = ESDIRK23(x0, @CSTRf, @CSTRjac, 10, 0, 200, 0.01, 0.01, parameters);
...
[X1,T1] = Dopri54(x0, @CSTR1Df, @CSTR1Djac, 10, 0, 200, 0.01, 0.01, parameters);
[Tcorrect, Xcorrect] = ode15s(parmcstr, [0 200], x0);
